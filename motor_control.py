...
def main():
    ...
    print("UI ready - rendering at 2x resolution for crisp graphics")
    print("Touch slider to change RPM, touch center button to start/stop")
                ...
                if touch.is_touched():
                    if touch.read_touch():
                        ...
                        if isinstance(action, int):
                            # Slider: Change RPM (only when motor not running)
